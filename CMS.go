...
func ParseP12(location, passPtr string) (privateKey *rsa.PrivateKey, certificate *x509.Certificate, err error) {

	p12, err := ioutil.ReadFile(location)
	if err != nil {
		return nil, nil, errors.New("parseP12: File not found")
	}
